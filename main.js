...
let infoOutsideHooked = false;
  ...
  const METRIC_INFO = {
    ...
    unemployment: {
      ...
      desc: 'Share of the workforce actively seeking employment.',
    ...
    total_refugees: {
      ...
      desc: 'Total refugee population residing in the country.',
  ...
  const renderDemoLegend = () => {
    ...
    legend.innerHTML = `
      <div class="compare-legend-heading">
        ...
        <span class="compare-legend-sub">Each colour represents a specific demographic group.</span>
      </div>
